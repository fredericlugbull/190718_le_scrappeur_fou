J'indique ci-dessous toutes les consignes nécessaires pour comprendre les attentes de ces exercices.

Ce cours fait partie du Bootcamp The Hacking Project (session 9 de l'été 2019).
